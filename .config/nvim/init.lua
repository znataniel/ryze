...
require('lazy').setup({
  ...
  -- Using `opts = {}` forces a plugin to be loaded.
...

  {
    ...
    config = function()
      ...
      -- Expand lsp server capabilities
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'yaml', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc' },
